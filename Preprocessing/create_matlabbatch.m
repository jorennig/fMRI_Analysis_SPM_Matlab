...
ESTIMATE_GLM = 1;
Preprocessing = 3; % 1= realign first 2=STC first 3= STC first + normalized--> wir machen 2/3
standardized = 1; %1 ja, 2 nein
...
for i = 1:size(subjects, 2)
    ...
    for j = 1:size(sessions, 2)
        ...
        if exist(fullfile('E:\fmrt\fMRI OBJ_Gestalt Nifti', sessions {j}, subjects{i})) ==7
            ...
            for k = 1:size(subFolds,1)
                t=t+1 
                %dir
                outputDir = char(fullfile('E:\fmrt\Results_fMRI\', subjects(i), Output_s(standardized)));
                ...
                data_path =  char(fullfile('E:\fmrt\fMRI OBJ_Gestalt Nifti', sessions (j), subjects(i), subFolds(k),Smooth_folder(standardized)));
    ...
    save(char(strcat(fullfile('E:\fmrt\Results_fMRI\Modellspezifikationen', subjects{i}, Output_s(standardized)), '\SPM.mat')), 'matlabbatch')
